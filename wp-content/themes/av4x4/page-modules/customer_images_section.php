...
<div class="recent_work_section clearfix">
    <div class="wrapper">
        <div class="clearfix customer_images_header">
            <h2>CUSTOMER IMAGES</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non est ac lorem ornare ultrices eu a tortor. Aliquam et pretium risus. Donec ut cursus magna, sed consectetur quam.
            </p>
        </div>
    </div>
    ...
    <a href="<?=get_permalink(13)?>" class="view_img_btn"> VIEW OTHER CUSTOMERS IMAGES</a>
